...
def compute_target(answers_dset, ans2label, id2question, name, args):
    ...
    ***answers_dset should be preprocessed***
    ...
    """
    # ref: https://github.com/airsplay/lxmert/blob/0db1182b9030da3ce41f17717cc628e1cd0a95d5/src/tasks/vqa_data.py#L33 Read data
    # ref: https://github.com/airsplay/lxmert/blob/0db1182b9030da3ce41f17717cc628e1cd0a95d5/src/tasks/vqa_data.py#L99 Top k data
    cache_root=osp.join(args.data_root, args.dataset, "cache", str(int(args.min_occurence)))
    ...
    for ans_entry in tqdm(answers_dset, desc=f'deal {name} json file'):
        ...
        # VQA2.0:
        # Standard answers must appear more than n times to be counted: 371950
        # Count all: 443757
        # pdb.set_trace()
        target.append({
